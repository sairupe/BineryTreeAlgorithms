...
class AvlTree<T extends Comparable<? super T>> {
  ...
  protected static class AvlNode<T> {
    ...
    public String toString() {
    	String leftStr = left == null? "" : left.element.toString();
    	String rightStr = right == null? "" : right.element.toString();
    	return element.toString() + " L:" + leftStr + " R:" + rightStr;
    }
  }
